...
<form method="POST" action="{{ route('departments.update',$department->id) }}" novalidate>
    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input class="form-control @error('department_name') is-invalid @enderror" name="department_name" id="department_name" value="{{ old('department_name',$department->department_name) }}" type="text">
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('user_id') is-invalid @enderror" name="user_id" id="user_id" data-placeholder="Department Head">
