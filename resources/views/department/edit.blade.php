...
<form method="POST" action="{{ route('department.update',$department->department_id) }}" novalidate>
    @csrf
    @method('PUT')
    <div class="card-body">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('company_id') is-invalid @enderror" name="company_id" data-placeholder="Company">
                        ...
                        @foreach ($companies as $company)
                            <option value="{{ $company->company_id }}" {{ old('company_id',$department->company_id) == $company->company_id ? 'selected' : '' }}>
