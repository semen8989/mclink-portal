    ...
    <div class="card-body">
        ...
        <div class="tab-content mt-3">
            <div class="form-group">
                ...
                <input class="form-control" name="purpose" id="purpose" type="text" value="{{ $wii->purpose }}">
            </div>
            <div class="form-group">
                <label for="title">Current Problem</label>
                <textarea class="form-control" name="problem" id="problem" cols="30" rows="10">{{ $wii->problem }}</textarea>
            </div>
            <div class="form-group">
                <label for="title">Suggestion to resolve</label>
                <textarea class="form-control" name="solution" id="solution" cols="30" rows="10">{{ $wii->solution }}</textarea>
            </div>
            <div class="form-group">
