                ...
                <div class="card-body">
                    <table class="table table-striped table-bordered" style="table-layout: fixed;">
                        ...
                        <tr>
                            ...
                            <td>{{ (!empty($details['19']['answer'])) ? $details['19']['prettyFormat'] : '---' }}</td>
                        </tr>
                        <tr>
                            <th>Age</th>
                        ...
                        <tr>
                            ...
                            <td>{{ (!empty($details['29']['prettyFormat'])) ? $details['29']['prettyFormat'] : '---' }}</td>
                        </tr>
                        <tr>
                            <th>Mobile Phone</th>
        ...
        <div class="card mb-0">
            <div class="card-header" id="headingTwo" role="tab">
                <h5 class="mb-0"><a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false"
                        aria-controls="collapseTwo">2. Languages / Dialects Proficiency</a></h5>
            </div>
        ...
        <div class="card mb-0">
            <div class="card-header" id="headingFive" role="tab">
                <h5 class="mb-0"><a class="collapsed" data-toggle="collapse" href="#collapseFive" aria-expanded="false"
                        aria-controls="collapseFive">5. Extra-Curricular Activities/Community Service</a></h5>
            </div>
        ...
        <div class="card mb-0">
            <div class="card-header" id="headingSix" role="tab">
                <h5 class="mb-0"><a class="collapsed" data-toggle="collapse" href="#collapseSix" aria-expanded="false"
                        aria-controls="collapseSix">6. Membership Details (Are you affiliated to any institution /
        ...
        <div class="card mb-0">
            <div class="card-header" id="headingNine" role="tab">
                <h5 class="mb-0"><a class="collapsed" data-toggle="collapse" href="#collapseNine" aria-expanded="false"
                        aria-controls="collapseNine">9. Employment History (5 Most Recent Employment)</a></h5>
            </div>
                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">2b. Have you been charged with any offence in a court of law or in any
                                    other country for
                            ...
                            <tr>
                                <th scope="row">3. Have you been charged with any offence in a court of law or in any
                                    other country for
                                    which the outcome is pending (excluding parking offences)?</th>
                            ...
                            <tr>
                                <th scope="row">4. Are you aware of being under any current police investigations or in
                                    any other
                            ...
                            <tr>
                                <th scope="row">5. Have you been or are you under any financial embarrassment i.e. (a)
                                    an undischarged
                                    bankrupt, (b) a judgement debtor, (c) have unsecured debts and liabilities of more
                                    than 3 months of
                            ...
                            <tr>
                                <th scope="row">6. Has your employment ever been terminated as a result of misconduct of
                                    service?</th>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">7. In the event where you have successfully passed the job interview(s)
                                    and received a
