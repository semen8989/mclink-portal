<ul class="nav nav-tabs" id="myTab1" role="tablist">
    ...
    <li class="nav-item"><a class="nav-link {{ (request()->segment(3) == 'assign' || request()->segment(3) == 'view') ? 'active' : '' }}" href="{{ route('sales_lead.assign_index') }}" role="tab" aria-controls="assign">Assign</a></li>
    ...
    <li class="nav-item"><a class="nav-link" href="{{ route('sales_lead.approval') }}" role="tab" aria-controls="approval">Approval</a></li>
</ul>