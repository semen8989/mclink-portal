<ul class="nav nav-tabs" id="myTab1" role="tablist">
    <li class="nav-item"><a class="nav-link {{ (request()->segment(3) == '' || request()->segment(3) == 'create' || request()->segment(3) == 'edit' || request()->segment(3) == 'details') ? 'active' : '' }}" href="{{ route('sales_lead.index') }}" role="tab" aria-controls="sales-lead">Sales Lead</a></li>
